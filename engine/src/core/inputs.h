...
VAPI b8 input_is_key_down(enum keys key);
VAPI b8 input_is_key_up(enum keys key);
VAPI b8 input_was_key_down(enum keys key);
VAPI b8 input_was_key_up(enum keys key);

void input_process_key(enum keys key, b8 pressed);

// Mouse Functions

VAPI b8 input_is_button_down(enum buttons button);
VAPI b8 input_is_button_up(enum buttons button);
VAPI b8 input_was_button_down(enum buttons button);
VAPI b8 input_was_button_up(enum buttons button);
VAPI void input_get_mouse_position(i32 *x, i32 *y);
VAPI void input_get_pervious_mouse_position(i32 *x, i32 *y);
...
void input_process_mouse_move(i16 x, i16 y);
void input_process_mouse_wheel(i8 z_delta);
>>>>>>> 4844ee18aba872e336b39137a75c606c1857e556
