...
// INFO: The main entry point of the application
int main(void) {
    ...
    if (!application_create(&game_inst)) {
        VFATEL("Application failed to create");
        return 1;
    }
    if (!application_run()) {
        VFATEL("application did not shutdwon gracefully");
        return 2;
    }
