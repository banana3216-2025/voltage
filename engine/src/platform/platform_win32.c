...
b8 platform_startup(platform_state *plat_state, const char *appication_name,
    ...
    wc.lpszClassName = "voltage_window_class";
    ...
    HWND handle = CreateWindowExA(window_ex_style, "voltage_window_class",
                                  appication_name, window_style, window_x,
...
LRESULT CALLBACK win32_process_message(HWND hwnd, u32 msg, WPARAM w_param,
    ...
    case WM_SIZE: {
        ...
        // TODO: fire an event for the window to resize;
    } break;
    case WM_KEYDOWN:
    case WM_SYSKEYDOWN:
    case WM_KEYUP:
    ...
    case WM_MOUSEHWHEEL: {
        ...
        if (z_delta != 0) {
            z_delta = (z_delta < 0)
                          ? -1
                          : 1; // INFO: flaten mouse wheel speed into -1 or 1,
                               // mebye it should be something more dynamic
